...
| `/interrupt <prompt>` | Interrupt the current agent response and handle this prompt next. Regular follow-up messages queue by default; use this for urgent redirects. |
